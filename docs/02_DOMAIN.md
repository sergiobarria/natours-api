...
`durationWeeks` is days divided by seven, rounded to one decimal. Public tour detail includes
chronological upcoming departures; the catalog list remains compact and does not embed schedules.
